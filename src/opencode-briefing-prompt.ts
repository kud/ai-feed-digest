...
export function buildBriefingPrompt(
  ...
  return [
    ...
    `Write the entire briefing in ${language} with an elegant, sophisticated, magazine-quality prose style—think The Economist, Le Monde Diplomatique, or The Atlantic.`,
    ...
    "  - FORBIDDEN: Summarizing what everyone already knows, safe platitudes, both-sides equivocation without synthesis.",
    "  - REQUIRED: At least 2-3 genuinely non-obvious insights that shift how readers understand what's happening.",
